...
* [EPL documentation](http://esper.espertech.com/release-8.1.0/reference-esper/html/index.html)
...
let's recall the running example: find every smoke event followed by a temperature event whose temperature is above 50 °C
...
One last step and we have Q7 finalised. We need to insert the results in the FireEvent stream
...
we are very close to the solution of the running example, we "just" need to count the number of events generated by the previous query over a sliding window of 10 seconds. So let's count the results of  `Q6`
